...
st.title("SKILLSCAN AI: Resume Categorization with Machine Learning")
st.subheader("An AI-driven resume classification tool leveraging NLP, TF-IDF, and Machine Learning to automatically categorize resumes into job roles with high accuracy.")
